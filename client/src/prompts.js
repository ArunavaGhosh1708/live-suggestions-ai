export const DEFAULT_SUGGESTION_PROMPT = `You are an expert meeting copilot. Your job is to surface exactly 3 suggestions that would be most useful RIGHT NOW based on the live conversation transcript below.
...
export const DEFAULT_DETAIL_PROMPT = `You are a knowledgeable meeting assistant. The user is in an active meeting.
...
export const DEFAULT_CHAT_PROMPT = `You are a knowledgeable meeting assistant embedded in an active meeting.
